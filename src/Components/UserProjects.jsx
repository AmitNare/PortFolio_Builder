...
export default function UserProjects() {
  ...
  <meta property="og:title" content="Projects | Portify - Showcase your works, portfolio projects to make your profile stand out." />
  <meta
  ...
  <meta
    property="og:image"
    content="https://yourdomain.com/assets/portify-projects-preview.png"
  />

  <meta name="twitter:card" content="summary_large_image" />
  <meta property="twitter:title" content="Projects | Portify - Showcase your works, portfolio projects to make your profile stand out." />
  <meta
  ...
  <title>Projects | Portify - Update and Manage Your Portfolio Projects</title>
</Helmet>
        ...
        {projects.length === 0 ? (
          <div className="w-full flex flex-col items-center justify-center text-center mt-10 text-lg">
            <message>
              ...
              <PlusCircleIcon className="inline w-5 h-5 mx-1 " /> icon above to
              add one!{" "}
            </message>
            <img
              src={not_found}
