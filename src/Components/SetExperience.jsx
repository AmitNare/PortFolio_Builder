            ...
            >
              <div class=" min-w-full group relative cursor-pointer overflow-hidden rounded-md shadow-xl ring-1 ring-gray-900/5 transition-all duration-300  hover:shadow-2xl sm:mx-auto sm:max-w-sm sm:rounded-lg ">
                ...
                <div class=" relative z-10 mx-auto max-w-md ">
                  <span class=" grid mt-3 h-10 w-40 place-items-center justify-center rounded-r-md bg-violet-500 transition-all duration-300 group-hover:bg-violet-400">
                ...
                <div className="mt-5 text-forground group relative cursor-pointer overflow-hidden transition-all duration-300 ">
                  ...
                  <div class="space-y-6 text-base leading-7 text-gray-600 transition-all duration-300 group-hover:text-white/90">
                    <div className="col-span-2 flex flex-col gap-1 p-1 pb-4">
                      <Textarea className=" text-foreground bg-transparent w-full h-32 resize-none group-hover:border-violet-600 custom-scrollbar overflow-auto ">
