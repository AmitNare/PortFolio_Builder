...
export default function UserPreview() {
  return (
    <>
      <Helmet>
        <meta name="title" content="Preview Portfolio | Portify" />
        <meta
          name="description"
        ...
        <meta
          property="og:image"
          content="https://yourdomain.com/assets/portify-preview-mode.png"
        />
        ...
        <title>Preview | Portify - Make updates and instantly visualize how your portfolio will look to visitors.</title>
      </Helmet>
      <div>
        <SetPortfolio />
      </div>
